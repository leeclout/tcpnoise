...
nc -vnzw1 $host 123 2>&1 | tee -a tcpnoise/$host
echo "$x" > tcpnoise.seed
}
...
while [ "0" -lt "1" ]
do
# test if under 240.0.0.0:0 11101111 11111111 11111111 11111111 11111111 11111111
if [ "$x" -lt "263882790666239" ]
	then 
		itoa "$x"
		# this will keep found connections at bottom of screen
#		echo ; echo ; grep open$ tcpnoise/*
